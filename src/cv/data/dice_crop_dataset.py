...
class DiceCropDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # label
        label = torch.tensor(self.manifest.loc[idx, 'label'], dtype=torch.float32)
